          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div ref={menuRef} style={{ position: 'relative' }}>
              <button onClick={() => setShowMenu(!showMenu)}
                style={{ width: '36px', height: '36px', borderRadius: '50%', background: avatar ? 'transparent' : t.accent, border: 'none', color: '#fff', cursor: 'pointer', fontSize: '13px', fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', padding: 0 }}>
              ...
              {showMenu && (
                <div style={{ position: 'absolute', right: 0, top: 'calc(100% + 8px)', background: t.surface, border: `1px solid ${t.border}`, borderRadius: '12px', minWidth: '200px', zIndex: 100, overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.3)' }}>
                  ...
                  {[
                    ...
                    { label: lang === 'pt' ? 'Foto de Perfil' : 'Profile Photo', action: () => { avatarInputRef.current?.click(); setShowMenu(false) } },
